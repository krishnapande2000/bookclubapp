...
public class EmailPasswordActivity extends Activity implements
    ...
    public void onCreate(Bundle savedInstanceState) {
       ...
       // setProgressBar(R.id.progressBar);
        ...
        findViewById(R.id.emailCreateAccountButton).setOnClickListener((View.OnClickListener) this);
        ...
        findViewById(R.id.reloadButton).setOnClickListener((View.OnClickListener) this);
    ...
    public void onStart() {
      ...
      FirebaseUser currentUser = mAuth.getCurrentUser();
        if(currentUser != null)
        {
            Toast.makeText(EmailPasswordActivity.this, "Logged in!", Toast.LENGTH_SHORT).show();
            startActivity(new Intent(EmailPasswordActivity.this,MainScreens.class));
            finish();
        }
        else{
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                           ...
                           //store the additional fields in database;
                            final String em = fuser.getEmail();
                            User user = new User();
                            user.setPhone("");
                            user.setName("");
                            user.setAddress("");
                            ...
                            FirebaseDatabase.getInstance().getReference("Users")
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()) {
                                        Toast.makeText(EmailPasswordActivity.this, getString(R.string.status_verification_succeeded), Toast.LENGTH_LONG).show();
                                        Toast.makeText(EmailPasswordActivity.this, "Logged in!", Toast.LENGTH_SHORT).show();
                                        startActivity(new Intent(EmailPasswordActivity.this, MainScreens.class));
                                        finish();
                                    } else {
                                        Toast.makeText(EmailPasswordActivity.this, getString(R.string.status_verification_failed), Toast.LENGTH_LONG).show();
